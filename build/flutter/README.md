...
* `messenger` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `messenger` - executable or bundle name on disk.
* `messenger` - display name shown in window titles and about app dialogs.
